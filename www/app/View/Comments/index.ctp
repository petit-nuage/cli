<div class="comments index">
	...
	<tr>
		...
		<td><?php echo h($comment['Comment']['uuid']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['content']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($comment['Type']['name'], array('controller' => 'types', 'action' => 'view', $comment['Type']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($comment['Task']['name'], array('controller' => 'tasks', 'action' => 'view', $comment['Task']['id'])); ?>
		</td>
