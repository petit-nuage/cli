<div class="milestones index">
	...
	<tr>
		...
		<td><?php echo h($milestone['Milestone']['completion']); ?>&nbsp;</td>
		<td><?php echo h($milestone['Milestone']['points']); ?>&nbsp;</td>
		<td><?php echo h($milestone['Milestone']['created']); ?>&nbsp;</td>
		<td><?php echo h($milestone['Milestone']['modified']); ?>&nbsp;</td>
		<td><?php echo h($milestone['Milestone']['started']); ?>&nbsp;</td>
		<td><?php echo h($milestone['Milestone']['finish']); ?>&nbsp;</td>
